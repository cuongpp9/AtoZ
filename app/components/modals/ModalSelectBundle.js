...
import { FilterBundleId } from 'components/filterselect';

const headers = ['Id', 'Name', 'Description', 'Status', ''];

class ModalSelectBundle extends React.Component {
  constructor() {
    super();
...
export default ModalSelectBundle;
